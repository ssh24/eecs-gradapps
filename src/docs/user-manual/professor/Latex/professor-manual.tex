...
\clearpage
Once you have submitted a filter you will be provided with a new table to match your filter.
\begin{figure}[!htb]
\begin{center}
...
\textbf{Pro-tip:} Create a preset called \emph{Default} with no columns or filters selected. You can then use this to load the default table help clear any data you put in the modal.
\label{fig:save_filter}
\end{figure}
